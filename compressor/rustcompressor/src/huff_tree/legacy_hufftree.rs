...
where
  S: Eq + Ord + Hash + Clone + Debug + Copy,
{
  ...
  pub fn into_mapping(self) -> HashMap<S, BitVec> {
    self.mapping
  }
...
mod tests {
  ...
  use crate::huff_tree::legacy_hufftree::Tree;
  ...
  use crate::huff_tree::legacy_hufftree::HuffEncoder;
